    ...
    int main()
    {
        ...
        Dice dice1 = Dice(label1, label2, label3, label4, label5, label6);
        cin >> label1 >> label2 >> label3 >> label4 >> label5 >> label6;
        Dice dice2 = Dice(label1, label2, label3, label4, label5, label6);

        dice2.set_state1(dice1.state[1]);
        dice2.set_state2(dice1.state[2]);

        if(     dice1.state[1] == dice2.state[1]
            &&  dice1.state[2] == dice2.state[2]
            &&  dice1.state[3] == dice2.state[3]
            &&  dice1.state[4] == dice2.state[4]
            &&  dice1.state[5] == dice2.state[5]
            &&  dice1.state[6] == dice2.state[6]
        ) cout << "Yes" << endl;
        else  cout << "No" << endl;
